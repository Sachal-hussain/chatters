...
<head>
    <meta charset="utf-8" />
    <title>C2C Form | SHJ INTERNATIONAL</title>
            ...
            $connect = $database_connection->connect();
             ...
             if (isset($_POST['depositAdd'])) {
               // $hdn_imagedata  = $_POST['hdn_images'];
                ...
                // Validate C2C method
                if ($payment_method === 'C2C' && ($hdn_imagedata == '' || $from_cust == '')) {
                    echo '<script>
                            Swal.fire({
                                ...
                                window.location.href = "c2cform.php";
                              });
                          </script>';
                    exit();
                }
                ...
                $stmt = $connect->prepare("INSERT INTO deposit (`date`, `pg_id`, `cust_name`, `gm_id`, `amount`, `bonus`, `tag`, `gid`, `payment_method`, `uname`, `from_cust`, `uid`, `status`, `created_at`) 
                                           VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
                if ($stmt === false) {
                    die('Prepare failed: ' . htmlspecialchars($connect->error));
                }

                $stmt->bind_param('sissddsisssiis', $date, $pgid, $decust_name, $cust_game_id, $cust_deposit, $cust_bonus, $tag, $gid, $payment_method, $uname, $from_cust, $uid, $status, $created_at);
                ...
                <div class="container-fluid">
                    ...
                    <div class="row justify-content-center" >
                        ...
                        <?php foreach ($pages as $key => $page) {
                            ...
                            $gameinfo_stmt = mysqli_query($connect, "SELECT id, g_name FROM gameinfo WHERE pg_id = $singleid AND status=0 ORDER BY g_name ASC");
                            $games_options = '';
                            ...
                            if(mysqli_num_rows($stmt) > 0){
                                while ($row = mysqli_fetch_assoc($stmt)) {
                                    ...
                                    <td class="bg-primary-subtle">'.$lastbonus.'</td>
                                    <td>'.$lastdate.'</td>
                                ...
                                <div class="card-body p-4"> -->
                                    <div class="p-3">
                                        ...
                                        <form  method="post" action="#" id="customerDepositfrm">
                                            ...
                                            <div class="mb-3">
                                                <label class="form-label" for="cust_name">To Customer</label>
                                                <div class="input-group mb-3 bg-light-subtle rounded-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group mb-3 bg-light-subtle rounded-3">
                                                   ...
                                                   <select name="payment_method" id="payment_method" class="form-control payment_method" required>
                                                        ...
                                                        <option value="Chime-<?php echo $page['id'];?>">Chime</option>
                                                        <option value="Paypal-<?php echo $page['id'];?>">Paypal</option>
                                                        <option value="Venmo-<?php echo $page['id'];?>">Venmo</option>
                                            ...
                                            <div class="mb-4 d-none" id="dep_image-<?php echo $page['id'];?>">
                                    ...
                                    <table class="table table-bordered table-sm d-none" id="pendingRedeem_tbl-<?php echo $page['id'];?>" >
                                      <thead>
                                        ...
                                        <tr>
                                          ...
                                          <th scope="col" class="bg-info-subtle">Paid</th>
