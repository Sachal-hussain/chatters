     ...
     $adddeposit='';
      ...
      if(mysqli_num_rows($query) > 0){
        while($row=mysqli_fetch_array($query)){
          ...
          '<tr>
            ...
            <td>'.$updated_at.'</td>
            <td>
            <button class="btn btn-outline-success btn-sm btn-sm waves-effect waves-light  pg_action m-1" data-id="'.$id.'" data-cashapp="'.$cashapp_closing.'" data-game="'.$game_closing.'" data-cashout="'.$cashout.'" data-pgname="'.$pagename.'" style="cursor:pointer;" title="add details" >Add Details</button>
      ...
      if(isset($_POST['save']))
      {
        ...
        if ($record_exists) {
          ...
          $sql_update = "UPDATE shift_closing SET cashapp_opening = ?, cashapp_closing=?,  redeem_closing=?, pending_redeem=?, cashout=?,redeem_for_other=?,  shift = ?, created_at = ?, uname = ?, uid = ?, updated_at = ? WHERE pg_id = ?";
          $stmt_update = $connect->prepare($sql_update);
          $stmt_update->bind_param("sssssssssisi", $cashapp_open, $cashapp_close, $redeem_close, $pending_redeem, $cashoutamount,$redeemforother, $shift, $end_date, $uname, $uid, $updated_at, $pg_id);
          $stmt_update->execute();
        } 
        else {
          // Insert new record
          $sql_insert = "INSERT INTO shift_closing (pg_id, cashapp_opening, cashapp_closing, redeem_closing, pending_redeem, cashout,redeem_for_other,  shift, created_at, uname, uid, updated_at) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
          $stmt_insert = $connect->prepare($sql_insert);
          $stmt_insert->bind_param("issssssssis", $pg_id, $cashapp_open, $cashapp_close, $redeem_close, $pending_redeem, $bonusamount,$redeemforother, $shift, $end_date, $uname, $uid, $updated_at);
          $stmt_insert->execute();
        }
        ...
        echo '<script>
                Swal.fire({
                    ...
                    window.location.href = "shift_end.php";
                });
              </script>';
        exit();
      }
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0 font-size-18">EOD</h4>
                        ...
                        <div class="col-md-8 col-lg-6 col-xl-12 ">
                            ...
                            <!-- <div class="card chat-conversation" data-simplebar="init">
                                <div class="card-body p-4"> -->
                                    <div class="p-3">
                                       <table class="table table-sm text-center" id="shiftrecords">
                                            <thead>
                                                <tr>
                                                  <th scope="col">#</th>
      ...
      <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
          <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title font-size-16" id="createticketLabel">Add Details - <span class="text-danger" id="actionpgname"></span></h5>
              ...
              <form method="post" action="#">
                ...
                <div class="mb-3">
                  ...
                  <div class="input-group mb-3 bg-light-subtle rounded-3">
                   ...
                   <input type="number" class="form-control" name="cashapp_close" id="cashapp_close" required>
                  </div>
                </div>
                ...
                <div class="mb-3">
                  ...
                  <div class="input-group mb-3 bg-light-subtle rounded-3">
                   ...
                   <input type="number" class="form-control" name="redeem_close" id="redeem_close" required >
                  </div>
                </div>
                <div class="mb-3">
                  ...
                  <div class="input-group mb-3 bg-light-subtle rounded-3">
                   ...
                   <input type="number" class="form-control" name="pending_redeem" id="pending_redeem" required>
                  </div>
                </div>
                <div class="mb-3">
                  ...
                  <div class="input-group mb-3 bg-light-subtle rounded-3">
                   ...
                   <input type="number" class="form-control" name="redeemforother" id="redeemforother" value="0" required >
                  </div>
                </div>
                <div class="mb-3">
                  ...
                  <div class="input-group mb-3 bg-light-subtle rounded-3">
                   ...
                   <input type="number" class="form-control" name="cashoutamount" id="cashoutamount" required>
                  </div>
                </div>
